...
def update_train_log(tag, time_window, eval_test, runtime, MODEL_VERSION, MODEL_VERSION_NOTE, test=False):
    """
    ...
    header = ['unique_id','timestamp','tag','time_window','eval_test','model_version',
    ...
    with open(logfile, 'a') as csvfile:
        ...
        to_write = map(str, [uuid.uuid4(), time.time(), tag, time_window, eval_test,
